...
//     this.updatedBenefitDescription = this.updatedBenefitName.bind(this);
//   }
...
//     this.setState({ updatedBenefitDescription: event.target.value });
//   };
...
//       benefitsName:
//       this.state.updatedBenefitName.length > 0
//       ? this.state.updatedBenefitName
//       : this.state.chosenBenefit.benefitsName,
//       description:
//       this.state.updatedBenefitDescription.length > 0
...
//     });
//     const chosenBenefit = await BenefitService.updateBenefit(id);
//     if (chosenBenefit.data) {
//       this.setState({
//         chosenBenefit: chosenBenefit.data,
//       });
//     }
//     console.log(this.state.chosenBenefit.id);    
//   }
...
//           // For each benefit we get, we are pushing into the BenefitList array
//           BenefitList.push({
...
//           onClick={() => this.openUpdateBenefitModal(benefit.id)}
//           ></button>),
...
class BenefitTable extends Component {
  ...
  createTable() {
    const benefitsData = {
      ...
      rows: [
        ...this.state.benefits.map((benefit, index) => ({         // NEW
